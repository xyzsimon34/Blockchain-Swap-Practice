...
import { Bars3Icon, HomeIcon, HomeModernIcon, XMarkIcon } from '@heroicons/react/24/outline'
import {
  ArchiveBoxXMarkIcon,
  ChevronDownIcon,
  PencilIcon,
        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <MenuItems className="absolute right-4 top-16 w-52 origin-top-right rounded-xl border border-white/5 bg-gray-700 p-1 text-sm/6 text-white shadow-lg focus:outline-none">
              <MenuItem>
                <Link href='/' className="group flex w-full items-center gap-2 rounded-lg py-1.5 px-3 hover:bg-gray-600">
                  <HomeModernIcon className="size-4 fill-white/30" />
                  {t('navbar.menu.home')}
                  <kbd className="ml-auto hidden font-sans text-xs text-white/50 group-hover:inline">⌘H</kbd>
                </Link>
              </MenuItem>
              <MenuItem>
